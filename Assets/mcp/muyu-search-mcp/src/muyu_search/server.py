...
# 尝试使用绝对导入（支持 mcp run）
try:
    from muyu_search.providers.grok import GrokSearchProvider
    from muyu_search.logger import log_info
    from muyu_search.config import config
    from muyu_search.sources import SourcesCache, merge_sources, new_session_id, split_answer_and_sources
    from muyu_search.planning import engine as planning_engine, result_cache, _split_csv
except ImportError:
...
@mcp.tool(
    ...
    """,
    meta={"version": "3.0.0", "author": "muyu"},
)
...
@mcp.tool(
    ...
    """,
    meta={"version": "1.0.0", "author": "muyu"},
)
...
@mcp.tool(
    ...
    **Edge Cases & Best Practices:**
    ...
    """,
    meta={"version": "1.3.0", "author": "muyu"},
)
async def web_fetch(
...
@mcp.tool(
    ...
    **Key Features:**
        ...
        - **Persistent Storage:** Model preference saved to ~/.config/muyu-search/config.json.
